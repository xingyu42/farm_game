...
export const helpList = [{
    ...
    list: [{
        ...
        icon: 27,
        title: '#nc购买土地 [序号]',
        desc: '按土地市场序号购买挂牌（分红率成交后锁定）'
    }, {
        icon: 28,
        title: '#nc我的挂牌 / #nc取消出售 [序号]',
        desc: '查看/取消自己的挂牌'
    }, {
        icon: 29,
        title: '#nc我的持有 / #nc转售土地 [序号]',
        desc: '查看持有列表/按原价挂牌转售（手续费5%销毁）'
    }, {
        icon: 34,
        title: '#nc转售市场 / #nc购买转售 [序号]',
        desc: '查看/购买转售挂牌（继承分红率）'
    }, {
        icon: 35,
        title: '#nc我的售出 / #nc赎回土地 [序号]',
        desc: '地主查看售出列表/按原价赎回'
    }]
}, {
    group: '🛡️ 偷菜防御',
